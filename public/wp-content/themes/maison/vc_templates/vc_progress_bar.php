...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<div class="inner-bar"><span class="vc_bar ' . esc_attr( implode( ' ', $bar_options ) ) . '" data-percentage-value="' . esc_attr( $percentage_value ) . '" data-value="' . esc_attr( $line['value'] ) . '"' . $line['bgcolor'] . '></span></div>';
	$output .= '</div>';
}
