...
class Maison_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'maison'),
            array( 'description' => esc_html__( 'Socials for website.', 'maison' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'maison-script-admin-js', get_template_directory_uri().'/js/admin/admin.js', array( 'jquery' ), APUS_FRAMEWORK_VERSION, true );
    }
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'maison'); ?></label>
            <br>
        <?php
...
register_widget( 'Maison_Socials_Widget' );