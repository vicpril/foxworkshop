...
class Maison_Vertical_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_vertical_menu',
            esc_html__('Apus Vertical Menu Widget', 'maison'),
            array( 'description' => esc_html__( 'Show Vertical Menu', 'maison' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'maison' ); ?></label>
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'nav_menu' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'nav_menu' )); ?>">
                <option value="" <?php selected( $instance['nav_menu'], $menu->slug ); ?>> <?php esc_html_e('--- Select Menu ---', 'maison'); ?></option>
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'position' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'position' )); ?>">
                <option value="left" <?php selected( $instance['position'], 'left' ); ?>><?php esc_html_e( 'Left', 'maison' ); ?></option>
                <option value="right" <?php selected( $instance['position'], 'right' ); ?>><?php esc_html_e( 'Right', 'maison' ); ?></option>
            </select>
        </p>
<?php
    }
...
register_widget( 'Maison_Vertical_Menu' );