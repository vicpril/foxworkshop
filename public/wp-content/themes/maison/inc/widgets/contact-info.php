...
class Maison_Widget_Contact_Info extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_contact_info',
            esc_html__('Apus Contact Info Widget', 'maison'),
            array( 'description' => esc_html__( 'Show Contact Info', 'maison' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <div class="address-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'address_icon' )); ?>"><?php esc_html_e( 'Icon:', 'maison' ); ?></label>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'address_content' )); ?>"><strong><?php esc_html_e('Address Content:', 'maison');?></strong></label>
        ...
        <div class="phone-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'phone_icon' )); ?>"><?php esc_html_e( 'Icon:', 'maison' ); ?></label>
            <div class="screenshot">
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'phone_content' )); ?>"><strong><?php esc_html_e('Phone Content:', 'maison');?></strong></label>
        ...
        <div class="email-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'email_icon' )); ?>"><?php esc_html_e( 'Icon:', 'maison' ); ?></label>
            <div class="screenshot">
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'email_content' )); ?>"><strong><?php esc_html_e('Email Content:', 'maison');?></strong></label>
...
register_widget( 'Maison_Widget_Contact_Info' );