...
class Maison_Single_Image extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_single_image',
            esc_html__('Apus Single Image Widget', 'maison'),
            array( 'description' => esc_html__( 'Show single image', 'maison' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'maison' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'maison' ); ?></label>
...
register_widget( 'Maison_Single_Image' );