...
class Maison_Featured_Video_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'apus_featured_video_widget',
            // Widget name will appear in UI
            esc_html__('Apus Featured Video Widget', 'maison'),
             // Widget description
            array( 'description' => esc_html__( 'Show Featured video', 'maison' ),)
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php echo esc_html__('Video link:', 'maison' ); ?></label>
            <br>
            ...
            <br>
            <?php echo esc_html__('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'maison' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php echo esc_html__('Video name:', 'maison' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width')); ?>"><?php echo esc_html__('Video width:', 'maison'); ?></label>
            <br>
...
register_widget( 'Maison_Featured_Video_Widget' );