...
if ( !class_exists("Maison_Mobile_Menu") ) {
    class Maison_Mobile_Menu extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( isset($item->apus_text_label) && !empty($item->apus_text_label) ) {
                switch ( $item->apus_text_label ) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'maison');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'maison');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Featured', 'maison');
                        break;
