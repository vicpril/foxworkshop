<?php
/**
 * Maison_WC_Product_Cat_Dropdown_Walker class
 *
 * @extends 	Walker
 * @class 		Maison_WC_Product_Cat_Dropdown_Walker
 * @version		1.6.4
...
if ( ! class_exists( 'Maison_WC_Product_Cat_Dropdown_Walker', false ) ) :

class Maison_WC_Product_Cat_Dropdown_Walker extends Walker {
