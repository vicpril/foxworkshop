...
if ( !function_exists( 'maison_autocomplete_search' ) ) {
    function maison_autocomplete_search() {
        if ( maison_get_config('enable_autocompleate_search', true) ) {
            ...
            add_action( 'wp_ajax_maison_autocomplete_search', 'maison_autocomplete_suggestions' );
            add_action( 'wp_ajax_nopriv_maison_autocomplete_search', 'maison_autocomplete_suggestions' );
        }
    }
}
add_action( 'init', 'maison_autocomplete_search' );

if ( !function_exists( 'maison_autocomplete_suggestions' ) ) {
    function maison_autocomplete_suggestions() {
